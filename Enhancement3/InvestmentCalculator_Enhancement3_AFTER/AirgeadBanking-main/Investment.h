...
private:
	...
	std::vector<double> yearlyBalancesWithoutDeposits; // vector to store year over year balances without deposits
	std::vector<double> yearlyInterestsWithoutDeposits; // vector to store year over year interests without deposits
	std::vector<double> yearlyBalancesWithDeposits; // vector to store year over year balances with deposits
	std::vector<double> yearlyInterestsWithDeposits; // vector to store year over year interests with deposits
};
